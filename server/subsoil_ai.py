...
<title>Subsoil AI</title>
<style>
  :root {
    --bg: #1e1e2e; --surface: #2a2a3e; --border: #3a3a5e;
    --accent: #7c5cbf; --accent2: #5b4a9e;
    --text: #e0e0f0; --muted: #8888aa; --green: #4caf79;
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  header span.badge { background: var(--accent); color: #fff;
                      font-size: 0.7rem; padding: 2px 8px; border-radius: 99px; }
  header .nav-erp { margin-left: auto; background: var(--bg); color: var(--text);
                    border: 1px solid var(--border); border-radius: 6px;
                    padding: 5px 12px; font-size: 0.8rem; text-decoration: none;
                    transition: all .15s; }
  header .nav-erp:hover { border-color: var(--accent); color: #fff; }
  .stage-bar { background: var(--surface); border-bottom: 1px solid var(--border);
               padding: 8px 16px; display: flex; gap: 6px; flex-wrap: wrap; }
  .stage-btn { background: var(--bg); border: 1px solid var(--border); color: var(--muted);
  ...
  .msg.ai { align-self: flex-start; background: var(--surface);
  ...
  .msg.ai code { background: #1a1a2e; padding: 1px 5px;
  ...
  #input { flex: 1; background: var(--bg); border: 1px solid var(--border);
           ...
           font-size: 0.95rem; resize: none; min-height: 42px; max-height: 180px;
           outline: none; transition: border-color .15s; }
  #input:focus { border-color: var(--accent); }
  button#send { background: var(--accent); border: none; color: #fff;
  ...
  button#clear { background: transparent; border: 1px solid var(--border);
                 color: var(--muted); border-radius: 8px; padding: 10px 14px;
...
<header>
  <div>🛢️</div>
  <h1>Subsoil AI</h1>
  <span class="badge">Помощник недропользователя РК</span>
  <a class="nav-erp" href="/">🛢 Фонд скважин</a>
  <a class="nav-erp" style="margin-left:8px" href="/stages.html">📑 Этапы</a>
  <a class="nav-erp" style="margin-left:8px" href="/erp/">📊 ERP</a>
</header>
<div class="stage-bar">
  <span style="color:var(--muted);font-size:.78rem;align-self:center">Быстрые запросы:</span>
...
<div id="chat">
  <div class="msg system">Задайте вопрос об этапах недропользования, документах, сроках или регуляторике РК.</div>
</div>
<footer>
